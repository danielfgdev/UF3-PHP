...
<body>
    ...
    if (isset($_POST["nombre"]) and isset($_POST["apellido"])) {
        ...
        from paciente 
        where apellido_paciente = :apellido_paciente
        or nombre_paciente = :nombre_paciente");
        $sqlPreparada->execute(array('apellido_paciente' => $apellido, 'nombre_paciente' => $nombre));
        echo "Pacientes con apellido $apellido y/o nombre $nombre: " . $sqlPreparada->rowCount() . "<br>";
